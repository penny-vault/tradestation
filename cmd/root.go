...
var rootCmd = &cobra.Command{
	Use:   "pv-tradestation",
	Short: "authenticate with the tradestation api",
	Long:  `pv-tradestation is a bridge between pvapi and the tradestation brokerage.`,
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName("tradestation.toml")
	}
